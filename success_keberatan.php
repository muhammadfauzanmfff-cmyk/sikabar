...
<head>
    ...
    <title>Permohonan Keberatan Berhasil - SiKaBar</title>
...
<body>
    <div class="container">
        <div class="success-container">
            ...
            <h2>Permohonan Keberatan Berhasil!</h2>
            <p class="mb-4">Terima kasih telah mengajukan permohonan keberatan. Permohonan Anda telah berhasil direkam dalam sistem kami.</p>
            ...
            <p class="mb-4">Silakan simpan kode tracking di atas untuk memantau status permohonan keberatan Anda.</p>
